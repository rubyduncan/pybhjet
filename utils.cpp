...
// standard parameters this function returns false in most zones; 
...
// Writing output --- instead of plot_write functions: 
void store_output(int size, double *en, double *lum, std::vector<DataPoint>& output_vector, double dist, double redsh) {
